...
module.exports = {
  ...
  head: [
    ...
    ['link', { rel: 'preload', href: 'https://cdn.jsdelivr.net/npm/octicons/build/font/octicons.css', as: 'style' }],
    ['link', { rel: 'preload', href: 'https://cdn.jsdelivr.net/npm/octicons/build/build.css', as: 'style' }],
