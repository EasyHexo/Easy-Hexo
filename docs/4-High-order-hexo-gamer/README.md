...
![新建会话.PNG](http://cdn.17shou.vip/2019/06/09/5cfca31deddc5.png)

   然后写上服务器公网 `IP​` ，输上密码，设置连接失败自动重连（因为我们会重启服务器）：

![设置会话IP.PNG](http://cdn.17shou.vip/2019/06/09/5cfca31d8aed5.png)
...
![宝塔一键包.jpg](http://cdn.17shou.vip/2019/06/09/5cfca31c93b85.jpg)
...
![hexo-admin配置代码.PNG](http://cdn.17shou.vip/2019/06/09/5cfca31bd1501.png)
...
![_config粘贴代码.PNG](http://cdn.17shou.vip/2019/06/09/5cfca31bcf7a6.png)
...
![Nginx添加网站.PNG](http://cdn.17shou.vip/2019/06/09/5cfca31c2776f.png)

3. 在进行一些其他的配置：

![SSL证书.PNG](http://cdn.17shou.vip/2019/06/09/5cfca31c653bf.png)

4. 在你的域名运营商那里设置 DNS​ 解析：

![DNS解析.PNG](http://cdn.17shou.vip/2019/06/09/5cfca31bcd477.png)

5. 输入域名，没有问题的话应该可以访问了！！

![没有问题.PNG](http://cdn.17shou.vip/2019/06/09/5cfca49be6a03.png)
